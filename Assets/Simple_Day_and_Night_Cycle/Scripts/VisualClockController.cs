...
public class VisualClockController : MonoBehaviour {
	...
	float hoursToDegrees = 360f / 12f; //the hour hand moves 6 degrees per second, but only according to the SecondsInAFullDay var
	float minsToDegrees = 360f / 60f; //the minute hand moves 30 degrees per second
